                    ...
                    return (
                      <div className="carrito-item" key={i}>
                        <div className="carrito-nombre">
                          ...
                          {v?.marca && (() => { const s = getStyles(v.marca); return <span style={{ marginLeft: 5 }}>· <span className="brand-badge" style={{ '--brand-color': s.color, '--brand-bg': s.background, '--brand-border': s.border }}>{v.marca}</span></span> })()}
                        </div>
