                ...
                <div style={{ background: 'var(--surface2)', borderRadius: 10, padding: '14px 16px', border: '1px solid var(--border)', marginBottom: 16 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                    <div style={{ flex: 1 }}>
                      ...
                      {data.producto_mas_vendido.marca && (() => { const s = getStyles(data.producto_mas_vendido.marca); return <span className="brand-badge" style={{ '--brand-color': s.color, '--brand-bg': s.background, '--brand-border': s.border }}>{data.producto_mas_vendido.marca}</span> })()}
                    ...
                    {data.stock.detalle.length === 0 ? (
                      ...
                      <div key={i} style={{ display: 'flex', alignItems: 'center', padding: '10px 16px', borderTop: '1px solid var(--border)', gap: 10 }}>
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          {s.marca && (() => { const st = getStyles(s.marca); return <span style={{ fontSize: 11, marginRight: 6 }}><span className="brand-badge" style={{ '--brand-color': st.color, '--brand-bg': st.background, '--brand-border': st.border }}>{s.marca}</span></span> })()}
