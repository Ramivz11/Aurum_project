    ...
    <>
      ...
      <div className="content page-enter">
        <div className="stats-grid">
          ...
          <div className="stat-card" style={{ background: 'linear-gradient(135deg, rgba(34,197,94,0.08) 0%, rgba(34,197,94,0.02) 100%)', borderColor: 'rgba(34,197,94,0.2)' }}>
            <div className="stat-label">📈 Ganancia del mes</div>
            <div className="stat-value" style={{ color: '#22c55e' }}>{fmt(analisis?.ganancia)}</div>
            <div style={{ fontSize: 10, color: 'rgba(34,197,94,0.6)', marginTop: 6, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
              {analisis?.margen_promedio}% margen
            </div>
          </div>
          {liquidez?.ganancia_acumulada > 0 && (
            <div className="stat-card" style={{ background: 'linear-gradient(135deg, rgba(59,130,246,0.08) 0%, rgba(59,130,246,0.02) 100%)', borderColor: 'rgba(59,130,246,0.2)' }}>
              <div className="stat-label">💰 Disponible para extraer</div>
              <div className="stat-value" style={{ color: '#3b82f6' }}>{fmt(liquidez?.ganancia_acumulada)}</div>
              <div style={{ fontSize: 10, color: 'rgba(59,130,246,0.6)', marginTop: 6, textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                acumulado sin extraer
              </div>
            </div>
          )}
        </div>
